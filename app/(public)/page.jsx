    ...
    <div>
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-slate-50 to-white">
        <div className="max-w-6xl mx-auto px-6 py-20 md:py-28 text-center">
          ...
          <p className="mt-5 text-slate-500 max-w-xl mx-auto text-base md:text-lg">
            Activate Gym handles member registration, biometric attendance, membership renewals, and payments — so your front desk can focus on members, not paperwork.
          </p>
          <div className="mt-8 flex flex-col sm:flex-row gap-3 justify-center">
            <Link href="/create-store"
              className="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white px-7 py-3 rounded-xl font-medium shadow-sm transition-all">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((f, i) => (
              <div key={i} className="bg-slate-50 border border-slate-100 rounded-2xl p-7 hover:shadow-md transition-shadow">
                <div className="w-12 h-12 rounded-xl bg-red-600 flex items-center justify-center mb-5">
      ...
      <section className="py-16 bg-gradient-to-r from-red-600 to-red-700">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-red-50 mb-8">Register your branch and get approved within 1-2 business days.</p>
          <Link href="/create-store"
            className="inline-flex items-center gap-2 bg-white text-red-700 px-7 py-3 rounded-xl font-medium hover:bg-red-50 transition-colors">
