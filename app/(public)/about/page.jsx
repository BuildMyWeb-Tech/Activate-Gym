    ...
    <div>
      ...
      <section className="bg-gradient-to-b from-slate-50 to-white">
        <div className="max-w-5xl mx-auto px-6 py-16 md:py-20 text-center">
          <div className="inline-flex items-center gap-2 bg-red-50 text-red-700 text-sm font-medium px-4 py-1.5 rounded-full mb-6">
            <Dumbbell size={15} /> About Activate Gym
          </div>
          <h1 className="text-3xl md:text-4xl font-bold text-slate-800 leading-tight max-w-2xl mx-auto">
            We built Activate Gym because front desks deserve better than a paper register
          </h1>
          <p className="mt-5 text-slate-500 max-w-xl mx-auto">
            Activate Gym brings member management, biometric attendance, and payment tracking into one
      ...
      <section className="py-16 bg-slate-50">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <Users size={36} className="text-red-600 mx-auto mb-4" />
